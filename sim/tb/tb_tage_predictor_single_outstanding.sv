// ============================================================================
// TAGE Predictor Wrapper Single-Outstanding Testbench
//   - Only one branch is allowed in the wrapper feedback delay line.
//   - PC is held stable until that branch leaves the wrapper delay line.
//   - The branch result is returned after PIPELINE_DEPTH cycles.
// ============================================================================
...
module tb_tage_predictor_single_outstanding;
    ...
    initial begin
        ...
        $fsdbDumpfile("tb_tage_predictor_single_outstanding.fsdb");
        $fsdbDumpvars(0, tb_tage_predictor_single_outstanding);
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (gap_cnt == BRANCH_GAP_CYCLES-1) begin
