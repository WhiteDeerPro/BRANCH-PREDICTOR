...
module tage_predictor #(
    ...
    tage_predictor_core #(
        ...
        .U_AGING_MODE     (U_AGING_MODE),
        .U_RESET_SCAN_ENTRIES(U_RESET_SCAN_ENTRIES),
        .USE_ALT_ON_NA    (USE_ALT_ON_NA),
        .USE_ALT_CTR_W    (USE_ALT_CTR_W),
        .USE_ALT_CTR_INIT (USE_ALT_CTR_INIT),
        .USE_ALT_REQUIRE_U_ZERO(USE_ALT_REQUIRE_U_ZERO),
        .UPDATE_ALT_ON_U_ZERO(UPDATE_ALT_ON_U_ZERO),
        .ALLOC_POLICY     (ALLOC_POLICY),
        .ALLOC_FAIL_DEC_U (ALLOC_FAIL_DEC_U),
        .ALLOC_FAIL_TICK_W(ALLOC_FAIL_TICK_W),
